...
export const RegisterCompany = () => {
	...
	const handleClick = () => {
		...
		dispatch(activeDoteAction([{ id: 1, label: "Company Information" }, { id: 1, label: "Information" }]));
		dispatch(removeToken());
		localStorage.clear();
	};

	const dot = [{ id: 1, label: "Company Information" }, { id: 2, label: "Company" }, { id: 3, label: "About company" }, { id: 4, label: "Contacts" }];
